config = {'dataset': 'mario',
          ...
          'excel_result_path': './result_final_mario/result.xlsx',
          'result_path': './result_final_mario/',
          'pl_path':'./prolog_final_mario/',
          'model_path':'./model_final_mario/',
          'log_file_path':'./result_final_mario/log.txt',
