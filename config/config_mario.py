config = {'dataset': 'mario',
          ...
          'excel_result_path': './result_hopfield_noise_0.3/result.xlsx',
          'result_path': './result_hopfield_noise_0.3/',
          'pl_path':'./prolog_hopfield_noise_0.3/',
          'model_path':'./model_hopfield_noise_0.3/',
          'log_file_path':'./result_hopfield_noise_0.3/log.txt',
          ...
          'train_task':['right_priority','up_priority', 'just_left','just_down', 'flower',
                        'right_one_step','left_one_step','chess_jump','bomb_far', 'sea'],
